...
static int test_cc_patch(struct wusb3801_chip *chip)
{
	int rc;
	//int ret;
	int rc_reg_08 = 0, rc_reg_0f = 0x0e;
	int i = 0;
...
{
	if (typec_cc_orientation == 1)
		*cc1 = 1;
	else if (typec_cc_orientation == 2)
		*cc2 = 1;
	else if (typec_cc_orientation == 0) {
		*cc1 = *cc2 = 0;
	}
	return 0;
}
