...
LB_CAMA_SOF_IGNORE:
	...
	/*  */
	if (IrqStatus & SOF_INT_ST) {
		if (g_virtual_cq_cnt_a == 0 || !(ISP_RD32(CAM_REG_CTL_SPARE2(reg_module))%0x100) != g_virtual_cq_cnt_a) {
			IRQ_LOG_KEEPER(module, m_CurrentPPB, _LOG_INF,
...
LB_CAMB_SOF_IGNORE:
	...
	/*  */
	if (IrqStatus & SOF_INT_ST) {
		if (g_virtual_cq_cnt_a == 0 || !(ISP_RD32(CAM_REG_CTL_SPARE2(reg_module))%0x100) != g_virtual_cq_cnt_b) {
			IRQ_LOG_KEEPER(module, m_CurrentPPB, _LOG_INF,
